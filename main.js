...
function getPlayerHeadshotUrl(playerName) {
  ...
  // Try current season format first
  return `https://assets.nhle.com/mug/nhl/20232024/${playerId}.png`;
}
...
const BOXES = [
  ...
  {id:20,label:'Goalie 2',type:'G',players:[{name:'Sergei Bobrovsky',team:'FLA',pts:56},{name:'Alexander Georgiev',team:'COL',pts:63},{name:'Pyotr Kochetkov',team:'CAR',pts:46},{name:'Jordan Binnington',team:'STL',pts:54},{name:'Andrei Vasilevskiy',team:'TB',pts:52}]},
